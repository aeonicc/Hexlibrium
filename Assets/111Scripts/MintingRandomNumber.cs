...
namespace HEXLIBRIUM
{
    ...
    public class MintingRandomNumber : State
    {
        ...
        private void Start()
        {
            //class _randomNumberEvent = new RandomNumberEvent();
        }
        ...
        private async void SubscribeToDatabaseEvents()
        {
            ...
            Debug.Log("SubscribeToDatabaseEvents");
        }
        ...
        private void HandleContractEventResponse(RandomNumberEvent newEvent, int requestId)
        {
            ...
            Debug.Log("HandleContractEventResponse");
        ...
        private async UniTask<string> CoRollDice()
        {
            //_tokenID = new BigInteger(vID);
            ...
            respp = await Moralis.ExecuteContractFunction(contractAddress, contractAbi, "d5value", parameters, value, gas, gasPrice);
        ...
        private async UniTask<string> CallContractFunction() //string inputPassword
        {
            ...
            string resp = await Moralis.ExecuteContractFunction(contractAddress, contractAbi, "callNumberResult", parameters, value, gas, gasPrice);
            
            Debug.Log("CallContractFunction");
