    ...
    public class Minting : State
{
    ...
    public static string GameItemContractAddress = "0x9FC6988a3dE6F4b245D10d088C6Ed01d35A87790"; //erc721 NFT
    ...
    private void OnEnable()
    {
        ...
        if (GameItemContractAddress == string.Empty || GameItemContractAbi == string.Empty)
        {
    ...
    private async UniTask<string> ExecuteMinting(string metadataUrl)
    {
        ...
        string resp = await Moralis.ExecuteContractFunction(GameItemContractAddress, GameItemContractAbi, "mintItem", parameters, value, gas, gasPrice);
